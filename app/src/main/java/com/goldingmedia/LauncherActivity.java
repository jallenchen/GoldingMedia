...
import com.goldingmedia.jni.GPIOUsbPower;
import com.goldingmedia.jni.flashMost;
...
import com.goldingmedia.utils.PermissionUtils;
...
public class LauncherActivity extends BaseActivity implements HandlerUtils.OnReceiveMessageListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediaCenterService.isMostPlug = DataSharePreference.getBooleanValue(mInstance,"MostPlug");
        if(MediaCenterService.isMostPlug){
            initMostTcp(0);
        }
        checkPermission();
    }
    ...
    protected void onResume() {
        super.onResume();
     //   PermissionUtils.requestMultiPermissions(LauncherActivity.this,mPermissionGrant);
    }
    ...
    public void OnEventCmd(EventBusCMD cmd) {
        switch (cmd.getCmdId()){
            ...
            case Contant.MsgID.NET_4G_OK:
                ...
                break;
            case Contant.MsgID.NET_MOST:
                int state = cmd.getIntValues();
                NLog.e(TAG, "NET_MOST---------ACTION_MOST_PLUG:"+state);
                if(state != 0){
            ...
            case Contant.MsgID.NET_MOST_OK:
                NLog.e(TAG, "NET_MOST_OK---------ACTION_MOST_OK:");

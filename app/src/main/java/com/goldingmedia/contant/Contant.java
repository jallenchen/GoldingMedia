...
public class Contant {
    ...
    public static final String BasePath = "/storage/emulated/0/goldingmedia/";
    ...
    public static final String PushPath = "/storage/emulated/0/goldingmedia/push/";
    public static final String UpgradePath = "/storage/emulated/0/goldingmedia/upgrade/";
//category path
    public static final String HOTZONE_PATH = "/storage/emulated/0/goldingmedia/hotzone/";
    public static final String MOVIESSHOW_PATH = "/storage/emulated/0/goldingmedia/moviesshow/";
    public static final String GOLDING_PATH = "/storage/emulated/0/goldingmedia/golding/";
    public static final String GAME_PATH = "/storage/emulated/0/goldingmedia/game/";
    public static final String ELINE_PATH = "/storage/emulated/0/goldingmedia/elive/";
    public static final String MYAPP_PATH = "/storage/emulated/0/goldingmedia/myapp/";
    public static final String ADS_PATH = "/storage/emulated/0/goldingmedia/ads/";
    ...
    public class MsgID {
        ...
        public final static int NET_MOST = 0x13;
...
//upgrade db
    ...
    public static final String MOST_DET_ACTION = "android.most.ACTION_MOST_PLUG";
